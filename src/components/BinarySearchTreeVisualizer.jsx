...
const binarySearchTreeAlgorithm = `
class TreeNode {
  constructor(value) {
    this.value = value;
    this.left = null;
    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
        ...
        <div style={{ textAlign: 'center', color: 'red' }}>
          <h1 className="text-3xl font-bold text-center text-red-600">BINARY SEARCH TREE VISUALIZATION</h1>
        </div>
      ...
      <div style={{ display: 'flex', height: '79vh', border: '1px solid #ddd' }}>
        <div style={{ flex: 1, borderRight: '1px solid #ddd' }}>
          <Editor
            ...
            value={binarySearchTreeAlgorithm}
